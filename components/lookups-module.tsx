...
export function LookupsModule({ modelTag }: LookupsModuleProps): ReactElement {
  ...
  return (
    <div className={`w-[90vw] max-w-xl sm:mx-auto mx-[5vw] bg-white border rounded-lg p-4 shadow-md hover:shadow-lg transition ${showSettings ? 'border-orange-500' : 'border-orange-500'}`}>
